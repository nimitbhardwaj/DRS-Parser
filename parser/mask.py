class OuterMask:
    ...
    def _print_state(self):
        print("relation_count: {}".format(self.relation_count))
        print("stack: {}".format(self.stack))
        print("stack_ex: {}".format(self.stack_ex))
        print("stack_variables".format(self.stack_variables))
        print("kpxes: {} {} {} {} {}".format(self.k, self.p, self.x, self.e, self.s))
...
class VariableMask:
    ...
    def _print_state(self):
        print ("stack: {}".format(self.stack))
        print ("stack_ex: {}".format(self.stack_ex))
        print ("stack_drs: {}".format(self.stack_drs))
        print ("k_use: {}".format(self.k_use))
        print ("user_k: {}".format(self.user_k))
        print ("xes".format(self.x, self.e, self.s))
    def _get_zeros(self, size):
        return [self.mask for i in range(size)]
